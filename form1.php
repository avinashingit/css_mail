...
var count1 = 1;
    ...
    cell5.innerHTML="<td><input type=\"text\" name=\"yoe"+count1+"\" size=\"8\"></td>";
    cell6.innerHTML="<td><input type=\"text\" name=\"yol"+count1+"\" size=\"8\"></td>";
    cell7.innerHTML="<td><input type=\"text\" name=\"percent"+count1+"\" size=\"5\"><input type=\"hidden\" name=\"count1\" value=\""+count1+"\"></td>";
    }
...
<table id="myTable1" border="1" style="width: 5px">
<tr><th>Sl.No</th><th>Degree Type</th><th>Degree</th><th>Institution/University</th><th>Year Of Entry</th><th>Year Of Leaving</th><th>Percentage</br>(out of 100)</th></tr>
</table>
